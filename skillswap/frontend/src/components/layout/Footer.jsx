...
const Footer = () => {
  ...
  return (
    <footer className={`border-t ${isDark ? 'border-neutral-800 bg-neutral-900' : 'border-neutral-200 bg-neutral-50'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center gap-2">
              <span className="text-xl font-semibold text-neutral-900 dark:text-white">SkillSwap</span>
            </Link>
            <p className="mt-4 text-sm text-neutral-500 dark:text-neutral-400 max-w-sm">
              A peer-to-peer skill-sharing and learning platform. Learn from others or share your expertise with the community.
            </p>
